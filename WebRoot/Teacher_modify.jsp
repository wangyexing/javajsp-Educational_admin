    ...
    <TR>
        <TD align="left" vAlign=top ><s:form action="Teacher/Teacher_ModifyTeacher.action" method="post" onsubmit="return checkForm();" enctype="multipart/form-data" name="form1">
            <table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
                ...
                <tr>
                    <td width=30%>出生日期:</td>
                    <td width=70%><input type="text" readonly  id="teacher.teacherBirthday"  name="teacher.teacherBirthday" onclick="setDay(this);" value='<%=teacher.getTeacherBirthday() %>'/></td>
                </tr>

                <tr>
                    <td width=30%>入职日期:</td>
                    <td width=70%><input type="text" readonly  id="teacher.teacherArriveDate"  name="teacher.teacherArriveDate" onclick="setDay(this);" value='<%=teacher.getTeacherArriveDate() %>'/></td>
                </tr>
                ...
                <tr>
                    <td width=30%>家庭地址:</td>
                    <td width=70%><input id="teacher.teacherAddress" name="teacher.teacherAddress" type="text" size="100" value='<%=teacher.getTeacherAddress() %>'/></td>
                </tr>

                <tr>
                    <td width=30%>附加信息:</td>
                    <td width=70%><input id="teacher.teacherMemo" name="teacher.teacherMemo" type="text" size="100" value='<%=teacher.getTeacherMemo() %>'/></td>
                </tr>
